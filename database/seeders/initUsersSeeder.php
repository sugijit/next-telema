    ...
    public function run(): void
    {
        DB::table('users')->insert([
            ...
            [
                ...
                'company_id' => "1",
                'role' => "user",
                'email' => "ren.estate.agent@gmail.com",
                'email_verified_at' => now(),
                'password' => Hash::make('Sayaka0000'),
                'pass_decrypt' => "Sayaka0000",
                'remember_token' => Str::random(10),
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'company_id' => "1",
                'role' => "nl_admin",
                'email' => "k.kikukawa@nl-nextlink.com",
                'email_verified_at' => now(),
                'password' => Hash::make('Kikugawa'),
                'pass_decrypt' => "Kikugawa",
                'remember_token' => Str::random(10),
                'created_at' => now(),
                'updated_at' => now(),
            ],
